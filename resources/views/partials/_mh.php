 <div class="br-header" style="background-color: #4cd137; font-weight: bold; font-size: 20px;">
      <div class="br-header-left">
        <div class="navicon-left hidden-md-down"><a id="btnLeftMenu" href=""><i class="icon ion-navicon-round"></i></a></div>
        <div class="navicon-left hidden-lg-up"><a id="btnLeftMenuMobile" href=""><i class="icon ion-navicon-round"></i></a></div>
       <!--  <div class="input-group hidden-xs-down wd-170 transition" style="background-color: #4cd137;">
          <input id="searchbox" type="text" class="form-control" placeholder="recherche" style="background-color: #4cd137;">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?php  echo "Bienvenue |"." ". $_SESSION['nom']; ?></span>
              <img src="http://via.placeholder.com/64x64" class="wd-32 rounded-circle" alt="">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href=""><i class="icon ion-ios-person"></i> Editer mon Profil</a></li>
                <li><a href=""><i class="icon ion-ios-gear"></i> Paramètres</a></li>
                <li><a href=""><i class="icon ion-ios-download"></i> Téléchargements</a></li>
                <li><a href=""><i class="icon ion-ios-star"></i> Favorits</a></li>
                <li><a href=""><i class="icon ion-ios-folder"></i> Collections</a></li>
                <li><a href="deconnexion.php"><i class="icon ion-power"></i> Deconnexion</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
